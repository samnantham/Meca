...
app.controller('GRDashboardCtrl', ['$scope', '$state', 'webServices', '$rootScope', 'authServices', '$timeout', '$window', 'NgMap', '$http', '$filter',
    function ($scope, $state, webServices, $rootScope, authServices, $timeout, $window, NgMap, $http, $filter) {
        ...
        $scope.activeTab = 1;
        $scope.gr_specialSites = [{'link':'https://toyotagazooracing.com/e-motorsports/','img':'img/GT-Cup.png'},{'link':'https://www.gran-turismo.com/gb/gtsport/sportmode/championship/archives','img':'img/Gran-Turismo.png'},{'link':'https://www.instagram.com/menadigitalmotorsports/','img':'img/mena.png'},{'link':'https://toyotagazooracing.com/e-motorsports/','img':'img/Youtube.png'}];

        $scope.YoutubeLinks = [{'country':'Jordan','link':'https://www.youtube.com/watch?v=FgI80AFnvcY'},{'country':'Oman','link':'https://www.youtube.com/c/OmanAutomobileAssociation-oaa'},{'country':'UAE','link':'https://www.youtube.com/user/TheATCUAE'},{'country':'Saudi Arabia','link':'https://www.youtube.com/watch?v=3T44vB-Keec'},{'country':'Bahrain','link':'https://www.youtube.com/channel/UCADrkUkU5nHrrdHszNcLCPg'},{'country':'The Finals','link':'https://www.youtube.com/watch?v=iM83LnJYdTA'},{'country':'Exhibition Races	','link':'https://www.youtube.com/watch?v=tsGSCGjivQI'}];
